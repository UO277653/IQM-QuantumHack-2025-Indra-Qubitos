@echo off
REM Example scripts for running battlefield tests
...
REM Example 1: Quick random test (100 battles)
...
REM Example 2: Balance test (160 battles - 20 per composition type)
...
REM Example 3: Performance test (500 battles)
...
REM Example 4: Large-scale test (1000 battles)
...
REM Example 5: Custom grid size
...
REM Example 6: Quick test with limited turns
